...
select cmr_law_number, effective_date, charge_code, type_class, description from import_mshp_charge_code_manuals  where description like '%DEATH%'  and mshp_version_id = 1 order by charge_code;
